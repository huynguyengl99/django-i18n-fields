...
class UserManager(BaseUserManager[_T]):
    ...
    def _create_user_object(self, email: str, password: str | None = None, **extra_fields: Any) -> _T:
        if not email:
    ...
    def _create_user(self, email: str, password: str | None = None, **extra_fields: Any) -> _T:
        """
    ...
    async def _acreate_user(self, email: str, password: str | None = None, **extra_fields: Any) -> _T:
        """See _create_user()"""
        user = self._create_user_object(email, password, **extra_fields)
        await user.asave(using=self._db)
        return user

    def create_user(self, email: str, password: str | None = None, **extra_fields: Any) -> _T:
    ...
    async def acreate_user(self, email: str, password: str | None = None, **extra_fields: Any) -> _T:
        extra_fields.setdefault("is_staff", False)
        extra_fields.setdefault("is_superuser", False)
    ...
    def create_superuser(self, email: str, password: str | None = None, **extra_fields: Any) -> _T:
